...
let precioProducto = 56;
let DescuentoDiez = precioProducto * 0.9; 

console.log("El producto cuesta " + precioProducto + " y con el descuento del 10% queda en " + DescuentoDiez);

// Ejercicio 12: Resto acumulado

let cantidad = 1786736;
cantidad %= 3;
...
let premioTotal = 690;
let numGanadores = 45;
let GananciaIndividual = premioTotal / numGanadores;

console.log (GananciaIndividual);
